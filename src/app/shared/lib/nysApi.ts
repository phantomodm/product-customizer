...
export default class CustomGloveQO {
    colors: any[];
    gloveData: { gloveSeries: {}; design:{}, data: { build:{} }; domTitle: string[]; canvas: { "element": string; "svgBase": string; }[]; };
    data: any;
    gloveSeries: any;
    design: any;
    canvas: any;
    ...
    constructor(productId) {
        ...
        // dbColor.once('value', (snap) => {
        //     _.forEach(snap.val(), (s) => {
        //         this.colors.push(s.hex)
        //     })
        // })

        // db.once('value', (snap) => {
        //     _.forEach(snap.val(), (r) => {
        //         if (id === r.product_id) {
        //             this.data = r;
        //             this.init();
        //         }
    ...
    loadCatcher() {
        let self = this;
        Snap.load("{{ cdn 'assets/img/nine-positions/catcher_back_view.svg'}}", (f) => {
    ...
    loadOutfield() {
        let self = this;
        Snap.load("{{ cdn 'assets/img/nine-positions/outfield_back_view.svg'}}", (f) => {
            this.svgMain.attr({ viewBox: "0 0 400 400" });
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/outfield_inside_view.svg'}}", (f) => {
            this.svgInside.attr({ viewBox: "0 0 400 400" });
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/outfield_side_view.svg'}}", (f) => {
            this.svgSide.attr({ viewBox: "0 0 400 400" });
    ...
    loadInfield() {
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/infield_swelt_back.svg'}}", (f) => {
            this.svgMain.attr({ viewBox: "0 0 400 400" });
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/infield_swelt_pocket.svg'}}", (f) => {
            this.svgInside.attr({ viewBox: "0 0 400 400" });
            // this.gloveCloneInsideVertical.attr({ viewBox: "0 0 400 400" });
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/infield_swelt_side.svg'}}", (f) => {
            this.svgSide.attr({ viewBox: "0 0 400 400" });
            // this.gloveCloneSideVertical.attr({ viewBox: "0 0 400 400" });
    ...
    loadFbase() {
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/fbase_back_view.svg'}}", function (f) {
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/fbase_inside_view.svg'}}", function (f) {
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/fbase_side_view.svg'}}", function (f) {
    ...
    loadInfield2Welt() {
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/infield_dwelt_back.svg'}}", (f) => {
            this.svgMain.attr({ viewBox: "0 0 400 400" });
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/infield_dwelt_pocket.svg'}}", (f) => {
            this.svgInside.attr({ viewBox: "0 0 400 400" });
            // this.gloveCloneInsideVertical.attr({ viewBox: "0 0 400 400" });
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/infield_dwelt_side.svg'}}", (f) => {
            this.svgSide.attr({ viewBox: "0 0 400 400" });
            // this.gloveCloneSideVertical.attr({ viewBox: "0 0 400 400" });
    ...
    loadPitcher() {
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/pitcher_open_back.svg'}}", function (f) {
            self.svgMain.attr({ viewBox: "0 0 400 400" });
            self.gloveCloneMainVertical.attr({ viewBox: "0 0 400 400" });
        ...
        Snap.load("{{ cdn 'assets/img/nine-positions/pitcher_side_view.svg'}}", function (f) {
            self.svgInside.attr({ viewBox: "0 0 400 400" });
            self.gloveCloneSideVertical.attr({ viewBox: "0 0 400 400" });
