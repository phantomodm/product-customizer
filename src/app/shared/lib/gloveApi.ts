  ...
  loadOutfield = () => {
    ...
    Snap.load("assets/images/nys_outfield_inside_view.svg", (f) => {
      ...
      var label = [
        ...
        { name: "pnki", x: 310, y: 111.5, title: "pinky inner" },
    ...
    Snap.load("assets/images/nys_outfield_side_view.svg", (f) => {
      var g = f.selectAll(
        "#of_x5F_vw1_x5F_wst, #of_x5F_vw1_x5F_thbi, #of_x5F_vw1_x5F_thbo, #of_x5F_vw1_x5F_indo, #of_x5F_vw1_x5F_plm,#of_x5F_vw1_x5F_web, #of_x5F_vw1_x5F_bnd, #of_x5F_vw1_x5F_wlt, #of_x5F_vw1_x5F_stch, #of_x5F_vw1_x5F_lce, #of_x5F_side_x5F_view"
      );
